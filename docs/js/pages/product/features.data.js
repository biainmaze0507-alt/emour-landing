/**
 * js/pages/product/features.data.js
 * ---------------------------------------------------------------------------
 * 핵심 기능 3종. 탭 하나가 { 탭 버튼, 실제 화면, 오른쪽 근거 } 를 모두 정의한다.
 *
 * screen은 화면에 그려질 내용의 "설계도"다.
 * 실제 DOM은 js/pages/product/featureTabs.js가 만든다.
...
export const FEATURES = [
...

  {
    ...
    detail: {
      kicker: "Feature 02",
      title: "무슨 말을 해야 할지 모를 때 세 가지 방향을 제안합니다",
      body:
        "정답을 하나로 정해 주지는 않습니다. 문제를 풀 것인지, 마음을 먼저 받을 것인지, " +
...

  {
    ...
    detail: {
      ...
      body:
        ...
        "“요즘 우리 대화가 어땠지”를 그래프로 확인할 수 있습니다.",
      points: [
